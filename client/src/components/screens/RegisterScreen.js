...
const RegisterScreen = () => {
    ...
    const registerHandler = async (e) => {
        ...
        try {
            await axios.post("/register", {username, email, password}, config);
            navigate("/login");
            }
    ...
    return (
        ...
        <Typography variant="body1" sx={{mt: 2}}>Already have an account? <Link href="/login">Login</Link></Typography>
